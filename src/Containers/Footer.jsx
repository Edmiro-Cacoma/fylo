...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-blue-footer pt-[12.375rem] lg:pl-[2.4375rem]">
      <div className="max-w-[81.5rem] mx-auto px-8">
        <MotionComponent as="a" className="inline-block" hrfe="/">
          <img
            src={logo}
            alt="Fylo"
            width={176}
        ...
        <MotionComponent
          ...
          className="grid mt-7 gap-[1.875rem] md:grid-cols-[1fr,1fr,auto] ctm:grid-cols-[auto,1fr,auto]"
        >
          <address className="flex flex-wrap gap-x-[6rem] gap-y-4 not-italic">
            <MotionComponent
              as="p"
              variants={textVariants}
              className="text-base icon icon-location | max-w-[40ch] "
            >
            ...
            <div className="flex basis-40 flex-col gap-[1.375rem] text-sm">
              <MotionComponent
                ...
                variants={textVariants}
                className="relative flex gap-[1.6875rem] icon icon-phone border-bottom "
              >
                +1-543-123-4567
              </MotionComponent>
              <MotionComponent
                ...
                variants={textVariants}
                className="relative flex gap-[1.5rem] icon icon-email border-bottom"
              >
                example@fylo.com
              </MotionComponent>
            </div>
          ...
          <nav
            aria-label="Footer"
            className="ctm:ml-[7.25rem] leading-[1.375rem] text-base"
          >
            <MotionComponent
              as="ul"
              variants={textVariants}
